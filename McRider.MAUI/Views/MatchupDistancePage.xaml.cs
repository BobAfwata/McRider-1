...
public partial class MatchupDistancePage : ContentPage
{
    static ILogger _logger = App.ServiceProvider.GetService<ILogger<MatchupDistancePage>>();

    public MatchupDistancePage(MatchupPageViewModel vm)
    {
        InitializeComponent();
        BindingContext = vm;
